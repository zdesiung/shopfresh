...
// Función simulada de pago (solo para pruebas)
async function processCulqiPayment(data: {
  cardNumber: string;
  expiry: string;
  cvv: string;
  name: string;
        ...
        <div className="flex gap-3">
          ...
          <div className="w-24">
            ...
            <input
              ...
              maxLength={4}
              placeholder="***"
              className="w-full mt-1 p-2 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-transparent focus:ring-2 focus:ring-in
